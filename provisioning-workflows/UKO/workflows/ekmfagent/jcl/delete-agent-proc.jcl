...
//SYSTSIN     DD    *
 ...
 DELETE '${instance-EKMF_ZOS_PROCLIB}(${instance-EKMF_AGENT_STC})' FILE(DD1)
 FREE FILE(DD1)
 ALLOCATE FILE(DD1) DATASET('${instance-EKMF_ZOS_PARMLIB}') SHR
 DELETE '${instance-EKMF_ZOS_PARMLIB}(${instance-EKMF_AGENT_STC})' FILE(DD1)
 FREE FILE(DD1)
 ...
 DELETE '${instance-EKMF_ZOS_STCJOBS}(${instance-EKMF_AGENT_STC})' FILE(DD2)
 FREE FILE(DD2)
#end
#end
/*