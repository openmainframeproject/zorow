...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
 DELETE ${instance-DB2_TEMP_HLQ}.TEMPDDL
...
//DDLWORK  DD DSN=${instance-DB2_TEMP_HLQ}.TEMPDDL,
//            DISP=(NEW,CATLG),
//            UNIT=SYSALLDA,
...
//OUT DD DISP=SHR,DSN=${instance-DB2_TEMP_HLQ}.TEMPDDL
//SYSTSPRT DD SYSOUT=*
//SYSTSIN DD *
...
//SYSTSIN  DD  *
 ...
 RUN PROGRAM(${instance-DB_PROGRAM}) PLAN(${instance-DB_PLAN}) LIB('${instance-DB2_RUNLIB}') 
  END
//SYSIN    DD DISP=SHR,DSN=${instance-DB2_TEMP_HLQ}.TEMPDDL
/*
